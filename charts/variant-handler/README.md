...
![Version: 1.0.1-beta1](https://img.shields.io/badge/Version-1.0.1--beta1-informational?style=flat-square)
...
| deployment.resources.limits.cpu | int | `1` |  |
...
| service.healthCheckPath | string | `"/health"` |  |
