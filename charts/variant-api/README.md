...
| istio.ingress.additionalHosts.private | list | `[]` | List of additional private prefixes to get custom URL, they are combined with istio.ingress.host to create additional URLs. |
| istio.ingress.additionalHosts.public | list | `[]` | List of additional public prefixes to get custom URL, they are combined with istio.ingress.host to create additional URLs. |
