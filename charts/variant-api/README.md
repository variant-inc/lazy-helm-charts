...
| maxUnavailable | int | `2` | Minimum number of pods that should be available always See [Pod Disruption Budget](https://kubernetes.io/docs/tasks/run-application/configure-pdb/) |
